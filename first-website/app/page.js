        ...
        <div className="bg-white">
            ...
            <div className="bg-green-100 flex text-center justify-start">
                ...
                <div className="ml-30 mr-25">
                    <h1 className="text-5xl text-black mt-20 mr-80">SIGMA BAKERY</h1>
                    <h2 className="text-3xl text-black mr-80">Homemade Cake</h2>
                </div>
            </div>
            ...
            <div className="text-center mt-6">
              ...
              <h2 className=" bg-orange-200 text-2xl text-black text-center mb-6 ml-155 mr-155 rounded-full">About Me</h2>
            ...
            <div className="bg-white p-12">
                ...
                <h2 className="bg-orange-200 text-2xl text-black text-center mb-6 ml-155 mr-155 rounded-full">Our Menu</h2>
                <div className="flex object-center">
                  <div className="ml-21 mr-10 bg-rose-200 rounded-xl w-64 p-4">
                    <img 
                      src="https://i.pinimg.com/1200x/00/20/89/002089eec1463a41e3c93fbdb12bf56d.jpg"
                      className="w-40 h-40 rounded-full object-cover mx-auto"
                  />
                    <h3 className="text-2xl text-center text-black mt-2">Lotus Cake</h3>
                    <h3 className="text-2xl text-center text-black">$10</h3>
                  </div>
                  <div className="ml-10 mr-10 bg-rose-200 rounded-xl w-64 p-4">
                    <img 
                      src="https://i.pinimg.com/736x/ac/89/e6/ac89e6c0e79023b2e0684901d1992ee9.jpg"
                      className="w-40 h-40 rounded-full object-cover mx-auto"
                  />
                    <h3 className="text-2xl text-center text-black mt-2">Strawberry Cake</h3>
                    <h3 className="text-2xl text-center text-black">$20</h3>
                  </div>
                  <div className="ml-10 mr-10 bg-rose-200 rounded-xl w-64 p-4">
                    <img 
                      src="https://i.pinimg.com/736x/41/f4/d5/41f4d5c2aec9e488a6c169b327d20e94.jpg"
                      className="w-40 h-40 rounded-full object-cover mx-auto"
                  />
                    <h3 className="text-2xl text-center text-black mt-2">Matcha Cake</h3>
                    <h3 className="text-2xl text-center text-black">$20</h3>
                  </div>
                  <div className="ml-10 mr-10 bg-rose-200 rounded-xl w-64 p-4">
                    <img 
                      ...
                      className="w-40 h-40 rounded-full object-cover mx-auto"
                  />
                    <h3 className="text-2xl text-center text-black mt-2">Peach Cake</h3>
                    <h3 className="text-2xl text-center text-black">$15</h3>
                  </div>
                </div>
            </div>
        </div>
